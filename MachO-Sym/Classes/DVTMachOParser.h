...
#ifndef DVTMachOParser_h
#define DVTMachOParser_h
...
/**
 @note:
    DVTMachOParser 仅仅适用与加载到内存中的Image
 */
class DVTMachOParser
{
public:
    // 构造函数
    DVTMachOParser(const mach_header* mh, bool dyldCacheIsRaw=false);
